...
var AdminAuthController = /*#__PURE__*/function () {
  ...
  _createClass(AdminAuthController, null, [{
    ...
    key: "checkRole",
    value: function () {
      var _checkRole = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
        var role, roleName;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              role = req.user.role;
              roleName = _RoleSysEnum["default"].getRoleSysName(role);
    ...
    key: "getCurrent",
    value: function () {
      var _getCurrent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
        var id, user;
            ...
            case 4:
              ...
              return _context5.abrupt("return", res.status(200).json({
                data: _objectSpread(_objectSpread({}, user), {}, {
                  role: {
                    role_id: user.role,
                    role_name: _RoleSysEnum["default"].getRoleSysName(user.role)
                  }
                })
              }));
            case 9:
...
var _default = exports["default"] = AdminAuthController;