...
var PostController = /*#__PURE__*/ (function () {
  ...
  _createClass(PostController, null, [
                  ...
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      ...
                      (_req$query = req.query),
                        ...
                        (_req$query$sortBy = _req$query.sortBy),
                        (sortBy =
                          _req$query$sortBy === void 0 ? "id" : _req$query$sortBy),
                        (_req$query$sortType = _req$query.sortType),
                        (sortType =
                          _req$query$sortType === void 0 ? "ASC" : _req$query$sortType),
                        (_req$query$page = _req$query.page),
                        (page = _req$query$page === void 0 ? 1 : _req$query$page),
                        (flimit = _req$query.flimit);
                      filter = {
                        search: search,
                        sortBy: sortBy,
                        sortType: sortType,
                ...
                while (1)
                  switch ((_context2.prev = _context2.next)) {
                    case 0:
                      _context2.prev = 0;
                      id = req.user.id;
                      (_generateCreatedByAnd = (0,
                      _generateCreatedByAndUpdatedBy.generateCreatedByAndUpdatedBy)(id)),
                        (created_by = _generateCreatedByAnd.created_by),
                        (updated_by = _generateCreatedByAnd.updated_by);
                      (_req$body = req.body),
                        ...
                        defaults: _objectSpread(
                          ...
                          {},
                          {
                            ...
                            photo:
                              photo === null ||
                              photo === void 0 ||
                              (_photo$file = photo.file) === null ||
                              _photo$file === void 0 ||
                              (_photo$file = _photo$file.response) === null ||
                              _photo$file === void 0 ||
                              (_photo$file = _photo$file.data) === null ||
                              _photo$file === void 0
                                ? void 0
                                : _photo$file.path,
                            filename:
                              photo === null ||
                              photo === void 0 ||
                              (_photo$file2 = photo.file) === null ||
                              _photo$file2 === void 0 ||
                              (_photo$file2 = _photo$file2.response) === null ||
                              _photo$file2 === void 0 ||
                              (_photo$file2 = _photo$file2.data) === null ||
                              _photo$file2 === void 0
                                ? void 0
                                : _photo$file2.filename,
                    ...
                    case 16:
                      ...
                      if (_photo)
                        cloudinary.uploader.destroy(
                          _photo === null ||
                            _photo === void 0 ||
                            (_photo$file3 = _photo.file) === null ||
                            _photo$file3 === void 0 ||
                            (_photo$file3 = _photo$file3.response) === null ||
                            _photo$file3 === void 0 ||
                            (_photo$file3 = _photo$file3.data) === null ||
                            _photo$file3 === void 0
                            ? void 0
                            : _photo$file3.filename
                        );
    ...
    },
    {
      key: "getAllStatus",
      value: (function () {
        var _getAllStatus = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee5(_, res) {
            var response;
            return _regeneratorRuntime().wrap(
                ...
                while (1)
                  switch ((_context6.prev = _context6.next)) {
                    case 0:
                      ...
                      // change this
                      user = req.user;
                      (_generateUpdatedBy = (0,
                      _generateCreatedByAndUpdatedBy.generateUpdatedBy)(
                        user === null || user === void 0 ? void 0 : user.id
                      )),
                        (updated_by = _generateUpdatedBy.updated_by);
                      (_req$body2 = req.body),
                        (title = _req$body2.title),
                        (photo = _req$body2.photo),
                        (tags = _req$body2.tags),
                        (_req$body2$filename_o = _req$body2.filename_old),
                        (filename_old =
                          _req$body2$filename_o === void 0
                            ? null
                            : _req$body2$filename_o),
                        (rest = _objectWithoutProperties(_req$body2, _excluded2));
                      _context6.next = 6;
                    ...
                    case 15:
                      ...
                      if (
                        !(
                          user.role !== _RoleSysEnum["default"].ADMIN &&
                      ...
                      return _context6.abrupt(
                        "return",
                        (0, _generateError.forbidden)(
                          new Error("Bạn không có quyền cập nhật bài viết này"),
                          res
                        )
                      );
                    case 18:
                        ...
                        _objectSpread(
                          ...
                          {},
                          {
                            ...
                            photo:
                              photo === null ||
                              photo === void 0 ||
                              (_photo$file4 = photo.file) === null ||
                              _photo$file4 === void 0 ||
                              (_photo$file4 = _photo$file4.response) === null ||
                              _photo$file4 === void 0 ||
                              (_photo$file4 = _photo$file4.data) === null ||
                              _photo$file4 === void 0
                                ? void 0
                                : _photo$file4.path,
                            filename:
                              photo === null ||
                              photo === void 0 ||
                              (_photo$file5 = photo.file) === null ||
                              _photo$file5 === void 0 ||
                              (_photo$file5 = _photo$file5.response) === null ||
                              _photo$file5 === void 0 ||
                              (_photo$file5 = _photo$file5.data) === null ||
                              _photo$file5 === void 0
                                ? void 0
                                : _photo$file5.filename,
                            updated_by: updated_by,
                          }
                        ),
                        {
                    ...
                    case 20:
                      ...
                      if (photo)
                        cloudinary.uploader.destroy(
                          photo === null ||
                            photo === void 0 ||
                            (_photo$file6 = photo.file) === null ||
                            _photo$file6 === void 0 ||
                            (_photo$file6 = _photo$file6.response) === null ||
                            _photo$file6 === void 0 ||
                            (_photo$file6 = _photo$file6.data) === null ||
                            _photo$file6 === void 0
                            ? void 0
                            : _photo$file6.filename
                        );
                    ...
                    case 30:
                      ...
                      if (_photo2)
                        cloudinary.uploader.destroy(
                          _photo2 === null ||
                            _photo2 === void 0 ||
                            (_photo2$file = _photo2.file) === null ||
                            _photo2$file === void 0 ||
                            (_photo2$file = _photo2$file.response) === null ||
                            _photo2$file === void 0 ||
                            (_photo2$file = _photo2$file.data) === null ||
                            _photo2$file === void 0
                            ? void 0
                            : _photo2$file.filename
                        );
                  ...
                  switch ((_context7.prev = _context7.next)) {
                    ...
                    case 4:
                      ...
                      return _context7.abrupt(
                        "return",
                        (0, _generateError.forbidden)(
                          new Error("Bạn không có quyền xóa bài viết này"),
                          res
                        )
                      );
                    case 8:
