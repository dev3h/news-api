  ...
  _createClass(PostController, null, [{
    ...
    value: function () {
      var _update = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
        var _photo$file4, _photo$file5, user, _generateUpdatedBy, updated_by, _req$body2, title, photo, tags, _req$body2$filename_o, filename_old, rest, oldImage, post, postByTitle, response, _photo$file6, _photo2$file, _photo2;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _req$body2 = req.body, title = _req$body2.title, photo = _req$body2.photo, tags = _req$body2.tags, _req$body2$filename_o = _req$body2.filename_old, filename_old = _req$body2$filename_o === void 0 ? null : _req$body2$filename_o, rest = _objectWithoutProperties(_req$body2, _excluded2);
              _context6.next = 6;
