...
var _AuthorFilter = _interopRequireDefault(require("../../../modelFilters/AuthorFilter"));
...
var ManagerAuthorController = /*#__PURE__*/function () {
  function ManagerAuthorController() {
    _classCallCheck(this, ManagerAuthorController);
  }
  _createClass(ManagerAuthorController, null, [{
    key: "getAll",
    value: function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _AuthorFilter["default"].handleList(filter);
            case 5:
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _context5.next = 3;
              return _models["default"].Admin.destroy({
                where: {
                  id: req.params.id
                }
              });
  ...
  return ManagerAuthorController;
}();
var _default = exports["default"] = ManagerAuthorController;