...
var _excluded = ["id", "password", "refreshToken"];
  ...
  _createClass(AuthController, null, [{
    ...
    value: function () {
      var _login = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var _req$body, _req$body2, admin, id, password, refreshToken, rest, comparePassword, accessToken, newRefreshToken;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              admin = _context.sent;
              id = admin.id, password = admin.password, refreshToken = admin.refreshToken, rest = _objectWithoutProperties(admin, _excluded);
              _context.next = 7;
              return bcrypt.compare((_req$body2 = req.body) === null || _req$body2 === void 0 ? void 0 : _req$body2.password, password);
            case 7:
              comparePassword = _context.sent;
              accessToken = comparePassword ? (0, _jwt.generateToken)(id) : null;
            ...
            case 13:
              ...
              return _context.abrupt("return", (0, _handle_error.badRequest)("Wrong password", res));
            case 16:
            ...
            case 19:
              ...
              (0, _handle_error.internalServerError)(_context.t0, res);
            case 22:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _context2.abrupt("return", (0, _handle_error.badRequest)(res, "Refresh token is required"));
            case 4:
              _context2.next = 6;
