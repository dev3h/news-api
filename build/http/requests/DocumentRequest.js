...
var DocumentRequest = function DocumentRequest(req, res, next) {
  var _joi$object$validate = _joi["default"].object({
      document_import: _joi["default"].string().required(),
      product_info: _joi["default"].array().items(_joi["default"].object({
  ...
  if (error) {
    return (0, _handle_error.badRequest)(error.details[0].message, res);
  }
  next();
};
var _default = DocumentRequest;
