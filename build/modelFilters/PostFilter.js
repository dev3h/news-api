            ...
            case 0:
              ...
              if (search) {
                queries.where = _defineProperty({}, _sequelize.Op.or, [{
                  title: _defineProperty({}, _sequelize.Op.like, "%".concat(search, "%"))
                }, {
                  id: search
                }]);
              }
              if ((user === null || user === void 0 ? void 0 : user.role) === _RoleSysEnum["default"].AUTHOR) {
                ...
                } // Thay userId bằng id của người đó
                ]));
              }
...
var _default = exports["default"] = PostFilter;