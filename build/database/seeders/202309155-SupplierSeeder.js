          ...
          function _callee$(_context) {
            while (1)
              switch ((_context.prev = _context.next)) {
                case 0:
                  _context.prev = 0;
                  suppliers = _toConsumableArray(Array(50)).map(function (company) {
                    return {
                ...
                case 6:
                  ...
                  console.error("Error seeding suppliers:", _context.t0);
                case 9:
                case "end":
            ...
            while (1)
              switch ((_context2.prev = _context2.next)) {
                ...
                case 5:
                  ...
                  console.error("Error undoing supplier seed:", _context2.t0);
                case 8:
                case "end":
